...
class Usuario extends CRUD
{
    ...
    public function setAceitouTermos($v)
    {
        $this->aceitouTermos = $v;
    }
    ...
    public function setAceitouPolitica($v)
    {
        $this->aceitouPolitica = $v;
    }
    public function getAceitouPolitica()
    {
        return $this->aceitouPolitica;
    }

    public function setDataAceite($v)
    {
        $this->dataAceite = $v;
    }
