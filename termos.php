...
<div class="container">
    ...
    <p>Bem-vindo(a) à Innovamind, uma plataforma destinada ao cadastro, divulgação e conexão de projetos, ideias e iniciativas entre idealizadores, patrocinadores, colaboradores e instituições.</p>
    <p>Ao criar uma conta, você declara que leu, compreendeu e concorda com estes Termos de Uso e com a Política de Privacidade.</p>

    <hr>
    <h2>1. FINALIDADE DA PLATAFORMA</h2>
    <p>A Innovamind oferece um ambiente digital para registro e divulgação de projetos, permitindo que terceiros possam entrar em contato com seus idealizadores para possíveis parcerias, colaborações ou patrocínios.</p>
    <ul>
