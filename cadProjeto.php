        ...
        <form action="dbProjeto.php" method="post" class="row g3 mt-3">
            ...
            <div class="row g-2 g-lg-3">
                <div class="col-sm-3 col-md-4">
                    <label for="localizacaoEstado" class="form-label">Estado de desenvolvimento</label>
            ...
            <div class="row g-2 g-lg-3">
                <div class="col-sm-5 col-md-6">
                    ...
                    <textarea name="contribuicao" id="contribuicoes" style="height: 200px" placeholder="Digite a contribuição necessária" required
                ...
                <div class="col-sm-5 col-md-6">
                    ...
                    <textarea name="descricaoDetalhada" id="descricaoDetalhada" style="height: 200px"
            ...
            <div class="row g-2 g-lg-3">
                <div class="col-12 mt-3 d-md-flex justify-content-md-end">
                    <button type="submit" name="btnGravar" class="btn btn-outline-light btn-lg">Salvar</button>
                </div>
            </div>
