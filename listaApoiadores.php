            ...
            <table class="table dataTable">
                ...
                <tbody>
                    ...
                    foreach ($lista as $a):
                        ?>
                        <tr>
                            <td class="text-center"><?= $a->idApoiadores ?></td>
                            <td class="text-center"><?= htmlspecialchars($a->nome) ?></td>
                            <td class="text-center"><?= ucfirst($a->tipo) ?></td>
                            <td class="text-center"><?= substr($a->descricao, 0, 60) ?>...</td>

                            <td class="text-center">
                                <div class="d-flex gap-1 justify-content-center">
                                    <form action="cadApoiadores.php" method="get" class="d-inline">
                                    ...
                                    <form action="dbApoiadores.php" method="post" class="d-inline">
